...
<body>
	<div class="container">
		...
		<div class="area-jogo">
			<div class="linha">
				<div class="casa" id="casa-1">1</div>
				<div class="casa" id="casa-2">2</div>
				<div class="casa" id="casa-3">3</div>
			</div>
			<div class="linha">
				<div class="casa" id="casa-4">4</div>
				<div class="casa" id="casa-5">5</div>
				<div class="casa" id="casa-6">6</div>
			</div>
			<div class="linha">
				<div class="casa" id="casa-7">7</div>
				<div class="casa" id="casa-8">8</div>
				<div class="casa" id="casa-9">9</div>
			</div>
		</div>
	</div>
